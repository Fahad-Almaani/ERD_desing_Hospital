...
(1, '2026-04-01', 'Mild chest pain', 'Medication and rest', 'Painkiller', 'Patient stable', 'Yes', 1,
1, 1),
(2, '2026-04-02', 'Migraine symptoms', 'MRI and medication', 'Migraine medicine', 'Needs
follow-up', 'Yes', 2, 3, 2),
(3, '2026-04-04', 'Fever infection', 'Antibiotics', 'Antibiotic', 'Monitor temperature', 'No', 4, 7,
4),
(4, '2026-04-06', 'Heart rhythm issue', 'ECG follow-up', 'Heart medication', 'Needs
monitoring', 'Yes', 6, 2, 6),
(5, '2026-04-07', 'Minor bone injury', 'Physiotherapy', 'Pain relief', 'Improving', 'Yes', 7, 5, 7),
(6, '2026-04-09', 'Heart follow-up', 'Continue treatment', 'Same medication', 'Better
condition', 'No', 1, 1, 9),
(7, '2026-04-10', 'Headache issue', 'MRI review', 'Painkiller', 'Check scan result', 'Yes', 2, 4,
10);
...
(6, '2026-04-09', 30.000, 'Paid', 'Card', '2026-04-13', 1, 1),  -- fixed
(7, '2026-04-10', 65.000, 'Partial', 'Insurance', '2026-04-14', 2, 2); -- fixed
